...
import com.keyroom.DateHelper.HapticFeedbackController;
import com.keyroom.DateHelper.TypefaceHelper;
import com.keyroom.DateHelper.Utils;
...
public class DatePickerDialog extends DialogFragment implements OnClickListener, DatePickerController {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // mDayOfWeekView.setBackgroundColor(getResources().getColor(R.color.colorFornt));
        mDayOfWeekView.setBackground(getResources().getDrawable(R.drawable.gradientbackground));
        ...
        okButton.setTypeface(TypefaceHelper.get(activity, "poppinsregular"));
        ...
        cancelButton.setTypeface(TypefaceHelper.get(activity, "poppinsregular"));
        ...
        try {
            ...
            mDayOfWeekView.setBackgroundColor(getResources().getColor(R.color.icon_color));
            //mDayOfWeekView.setBackground(getResources().getDrawable(R.drawable.gradientbackground));
            //view.findViewById(R.id.day_picker_selected_date_layout).setBackground(getResources().getDrawable(R.drawable.gradientbackground));
            view.findViewById(R.id.day_picker_selected_date_layout).setBackgroundColor(getResources().getColor(R.color.icon_color));
            okButton.setTextColor(getResources().getColor(R.color.icon_color));
            cancelButton.setTextColor(getResources().getColor(R.color.icon_color));
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        updateDisplay(false);
        //TODO
        setAccentColor(getResources().getColor(R.color.icon_color));
        if (Content.ShowDay) {
            setCurrentView(MONTH_AND_DAY_VIEW);
        } else if (Content.ShowMonth) {
            setCurrentView(99999);
        } else {
    ...
    public void onDismiss(DialogInterface dialog) {
        ...
        Content.IsToMonth = false;
        Content.IsComplicatedFlagMonth = false;
        ...
        switch (viewIndex) {
            ...
            case 99999:
                ...
                if (mCurrentView != viewIndex) {
                    ...
                    mAnimator.setDisplayedChild(MONTH);
                    mCurrentView = viewIndex;
                }
                pulseAnimator.start();

                CharSequence yearString1 = MONTH_FORMAT.format(millis);
                mAnimator.setContentDescription(mYearPickerDescription + ": " + yearString1);
                Utils.tryAccessibilityAnnounce(mAnimator, mSelectYear);
                break;
        }
    }
    ...
    public void onYearSelected(int year) {
        ...
        /*//Log.e("TempCalendar MONTH","--"+TempCalendar.get(Calendar.MONTH));
        //Log.e("TempCalendar YEAR","--"+TempCalendar.get(Calendar.YEAR));*/
    ...
    @Override
    public void onMonthSelected(/*int year,*/ int month/*, int day*/) {
        /*mCalendar.set(Calendar.YEAR, year);*/
        mCalendar.set(Calendar.MONTH, month);
        /*mCalendar.set(Calendar.DAY_OF_MONTH, day);*/
        TempCalendar = mCalendar;
