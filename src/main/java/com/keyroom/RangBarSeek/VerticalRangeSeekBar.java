...
public class VerticalRangeSeekBar extends RangeSeekBar {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        } else if (widthMode == View.MeasureSpec.AT_MOST && getParent() instanceof ViewGroup
                && widthSize == ViewGroup.LayoutParams.MATCH_PARENT) {
            widthSize = View.MeasureSpec.makeMeasureSpec(((ViewGroup) getParent()).getMeasuredHeight(), View.MeasureSpec.AT_MOST);
        } else {
            int heightNeeded;
