...
public class GalleryOfferImageAdapter extends RecyclerView.Adapter<GalleryOfferImageAdapter.ViewHolder> {

    Context mContext;
    ArrayList<SearchModel.Gallery> galleriesImages = new ArrayList<>();
    SearchModel.Rows serachHotelModel;

    public GalleryOfferImageAdapter(Context context, ArrayList<SearchModel.Gallery> galleriesImages, SearchModel.Rows serachHotelModel) {
    ...
    @NonNull
    @Override
    public GalleryOfferImageAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.item_galleryimages, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull GalleryOfferImageAdapter.ViewHolder holder, int position) {
