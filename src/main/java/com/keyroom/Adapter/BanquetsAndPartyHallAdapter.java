...
public class BanquetsAndPartyHallAdapter extends RecyclerView.Adapter<BanquetsAndPartyHallAdapter.ViewHolder> {
    private final int limit = 5;
    Context mContext;
    ArrayList<BanquetsAndPartyHallModel.Banquets> banquetsArrayList = new ArrayList<>();

    public BanquetsAndPartyHallAdapter(Context mContext, ArrayList<BanquetsAndPartyHallModel.Banquets> banquetsArrayList) {
    ...
    @NonNull
    @Override
    public BanquetsAndPartyHallAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull BanquetsAndPartyHallAdapter.ViewHolder holder, int position) {
    ...
    public int getItemCount() {
        if (banquetsArrayList.size() > limit) {
            return limit;
        } else {
