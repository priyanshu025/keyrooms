...
public class ImagePickerActivity extends AppCompatActivity {
   ...
   /* private static String queryName(ContentResolver resolver, Uri uri) {
    ...
    private void cropImage(Uri sourceUri) {
        Uri destinationUri = Uri.fromFile(new File(getCacheDir(), "new_file"));
        UCrop.Options options = new UCrop.Options();
        options.setCompressionQuality(IMAGE_COMPRESSION);

        // applying UI theme
        options.setToolbarColor(ContextCompat.getColor(this, R.color.mainicon_color));
        options.setStatusBarColor(ContextCompat.getColor(this, R.color.mainicon_color));
        options.setActiveWidgetColor(ContextCompat.getColor(this, R.color.mainicon_color));
